define(["exports","../../src/cms-login.js"],function(_exports,_cmsLogin){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* ignoreName */ /* skipSlots */});_exports.cmsOverlay=_exports.$cmsOverlay=void 0;class cmsOverlay extends(0,_cmsLogin.mixinBehaviors)(_cmsLogin.IronOverlayBehavior,_cmsLogin.PolymerElement){static get template(){return _cmsLogin.html`
    <style>
      :host {
        background: inherit;
        color: black;
    ...
    <slot></slot>
`}static get is(){return"cms-overlay"}ready(){super.ready()}}_exports.cmsOverlay=cmsOverlay;customElements.define(cmsOverlay.is,cmsOverlay);var cmsOverlay$1={cmsOverlay:cmsOverlay};_exports.$cmsOverlay=cmsOverlay$1;const _DBW=new _cmsLogin.dataBaseworker,__DEV=!0,_STYLES=_DBW.getElementAssets("cms-confirm",__DEV);class cmsConfirm extends _cmsLogin.PolymerElement{static get template(){return _cmsLogin.html`

import{html as html$1,cmsMiddlePageTemplate,afterNextRender,html$2 as html,render,cmsItemTemplate,Debouncer,microTask,cmscategoriesLib,cmsPagesLib}from"../../src/cms-login.js";class cmsPageListItem extends cmscategoriesLib(cmsPagesLib(cmsItemTemplate)){static get is(){return"cms-page-list-item"}static get properties(){return{translator:{type:Object,notify:!0/* ignoreName */ /* skipSlots */,value:function(){return MyAppGlobals[window.cms];//MyAppGlobals.translator

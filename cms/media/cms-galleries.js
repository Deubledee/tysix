define(["../cms-login.js"],function(_cmsLogin){"use strict";const Consts=new _cmsLogin.Setter;class cmsGalleryItem extends _cmsLogin.cmsItemTemplate{static get template(){return _cmsLogin.html`
        <style>    
        :host {
            position: relative;
            display: block;
        ...
        <slot name="table"></slot> 
            ...
            </a>`}static get _getSilentAnchor(){return _cmsLogin.html`

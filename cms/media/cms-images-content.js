define(["../../src/cms-login.js"],function(_cmsLogin){"use strict";const ModeloInfo="W3siYWRkZWRUbyI6IiIsImF1dGhvciI6e30sImRhdGVDcmVhdGVkIjoiIiwiZnJvbURyb3BTaGlwIjoiIiwiZ2FsbGVyeSI6IiIsImdyb3VwIjoiICIsImlkIjoiIiwicmVtb3ZlZCI6IiIsInRpdGxlIjoiIiwidHlwZSI6IiIsInVybCI6IiJ9XQ==";class cmsImagesContent extends(0,_cmsLogin.mixinBehaviors)(_cmsLogin.IronCheckedElementBehavior,(0,_cmsLogin.cmsMediaLib)(_cmsLogin.cmsContentTemplate)){static get _getStyles(){return _cmsLogin.html`
            ...
            `}static get _getLangButton(){return _cmsLogin.html`
                  ...
                  </cms-pop-input>`}static get _getXbutton(){return _cmsLogin.html` 
        <paper-button slot="button" class="exex" on-click="_addTitle">
            x
        </paper-button> 
         `}static get _getLangAnchor(){return _cmsLogin.html`   
                ...
                </section>`}static get _getContentItems(){return _cmsLogin.html`
        <div container>
            <div bottom>

define(["require","./cms-login.js"],function(_require,_cmsLogin){"use strict";_require=babelHelpers.interopRequireWildcard(_require);class cmsMedia extends _cmsLogin.cmsTopPageTemplate{static get topTitle(){return _cmsLogin.html`
    <div class="topLabel"> [[Media]] 
      <paper-icon-button-light>
        <iron-icon icon="image:photo-library" aria-label="Content">
        </iron-icon>
      </paper-icon-button-light>
    </div>`}static get topPages(){return _cmsLogin.html`

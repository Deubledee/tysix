import{cmsItemTemplate,html,Debouncer,microTask,html$2 as html$1,render,cmsArticlesLib,cmsMiddlePageTemplate,afterNextRender}from"../../src/cms-login.js";class cmsArticleItem extends cmsArticlesLib(cmsItemTemplate){static get _getStyles(){return html`
        shop-image{
            top: 1px; 

define(["exports","../../src/cms-login.js"],function(_exports,_cmsLogin){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* ignoreName */ /* skipSlots */});_exports.cmsDropdownMenu=_exports.$cmsDropdownMenu=void 0;class cmsDropdownMenu extends _cmsLogin.cmsDropdownMenuTemplate{static get is(){return"cms-dropdown-menu"}static get properties(){return{lang:{type:String,notify:!0},langs:{type:Object,value:{}},items:{type:Array,notify:!0,observer:"__setValues"},translator:{type:Object,notify:!0,value:function(){return MyAppGlobals[window.cms]}}}}_log(data){console.log(data)}ready(){super.ready();this.translator.target("cms-content-item","setLangObject",this._setLObj.bind(this));this.translator.target("cms-content-item","changeLang",this._setLang.bind(this),!0);this.translator.shoot("cms-content-item","setLangObject")}_setLObj(res,querySnapshot){if("data"in querySnapshot){let langs=querySnapshot.data();res.call(this,langs)}}_setLang(res,lang){this.lang=lang;res.call(this,this.itemLabel,"title");res.call(this,"cancel","cancel")}__changeLang(){this.lang=this.translator.lang;this.translator.changeItemTitleLang.call(this,this.itemLabel,"title");this.translator.changeItemTitleLang.call(this,"cancel","cancel")}setValues(data){console.log(data);if(!!data){let obj=data;this.list=data.items;Reflect.deleteProperty(obj,"items");this._setValues(obj);this.__changeLang()}}_setValues(data){this.temp=this.item;for(let par in data){this.set("itemText",data[par])}this._setLabels(data)}}_exports.cmsDropdownMenu=cmsDropdownMenu;customElements.define(cmsDropdownMenu.is,cmsDropdownMenu);var cmsDropdownMenu$1={cmsDropdownMenu:cmsDropdownMenu};_exports.$cmsDropdownMenu=cmsDropdownMenu$1;const Modelo="eyJpbWFnZXMiOnsiY29udGVudCI6W119LCJsYW5nIjp7ImFydGljbGVOYW1lIjoiIiwibGFuZyI6IiIsImRlc2NyaXB0aW9uIjoiIiwidHlwZSI6IiJ9fQ==",ModeloInfo="";class cmsArticleContent extends(0,_cmsLogin.cmscategoriesLib)((0,_cmsLogin.cmsArticlesLib)(_cmsLogin.cmsContentTemplate)){static get _getStyles(){return _cmsLogin.html`
        div[placerbottom] {
            overflow: auto;
        }
        .row-layout{
        ...
        `}static get _getAnchor(){return _cmsLogin.html`

import{PolymerElement,html$1 as html}from"./cms/cms-login.js";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<dom-module id="shop-button">
  <template>
    <style>
...
</iron-iconset-svg>`;document.head.appendChild($_documentContainer$1.content);class Shop404Warning extends PolymerElement{static get template(){return html`

define(["../../src/cms-login.js"],function(_cmsLogin){"use strict";class cmsImages extends(0,_cmsLogin.mixinBehaviors)(_cmsLogin.IronCheckedElementBehavior,(0,_cmsLogin.cmsMediaLib)(_cmsLogin.cmsMiddlePageTemplate)){static get _topLabel(){return _cmsLogin.html`  
        ...
        </section>`}static get _getTable(){let template=_cmsLogin.html`
            <div table> 

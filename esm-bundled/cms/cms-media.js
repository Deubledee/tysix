define(["require","../src/cms-login.js"],function(_require,_cmsLogin){"use strict";_require=babelHelpers.interopRequireWildcard(_require);class cmsMedia extends _cmsLogin.cmsTopPageTemplate{static get topTitle(){return _cmsLogin.html`
      <a href="[[_getStr2(page)]][[_queryContent2(index, page)]]">  
          <paper-button  aria-label="Go back page">                   
          [[_getPage2(page)]]
          </paper-button>               
      </a> 
        `}static get topPages(){return _cmsLogin.html`
      <section>
      ...
      </section>`}static get viewPages(){return _cmsLogin.html`

import{IronOverlayBehavior,mixinBehaviors,PolymerElement,html,microTask,Debouncer,dataBaseworker}from"../cms-login.js";class cmsOverlay extends mixinBehaviors(IronOverlayBehavior,PolymerElement){static get template(){return html`
    <style>
      :host {
        background: inherit;
        color: black;
    ...
    <slot></slot>
`}static get is(){return"cms-overlay"}ready(){super.ready()}}customElements.define(cmsOverlay.is,cmsOverlay);var cmsOverlay$1={cmsOverlay:cmsOverlay};const _DBW=new dataBaseworker,__DEV=!0,_STYLES=_DBW.getElementAssets("cms-confirm",__DEV);class cmsConfirm extends PolymerElement{static get template(){return html`

import{cmsItemTemplate,html,Debouncer,microTask,cmsMiddlePageTemplate,cmsItemImageTemplate,Setter}from"../cms-login.js";class cmsArticleItem extends cmsItemTemplate{static get _getStyles(){return html`
        ...
        </div>    `}static get _getNavside(){return html`

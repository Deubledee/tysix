import{PolymerElement,html as html$1,setPassiveTouchGestures,setRootPath,Debouncer,microTask,Polymer,dom,html$1 as html,IronButtonState,IronControlState,PaperRippleBehavior,IronMenuBehavior,IronMenuBehaviorImpl,IronResizableBehavior,dataBaseworker}from"./cms-login.js";Polymer({is:"iron-location",properties:{/**
...
}else if(cl.contains("contract")){cl.remove("contract")}}});const template$1=html`<iron-iconset-svg name="hardware" size="24">
<svg><defs>
...
</iron-iconset-svg>`;document.head.appendChild(template$1.content);const template$2=html`<iron-iconset-svg name="av" size="24">
<svg><defs>
...
</iron-iconset-svg>`;document.head.appendChild(template$2.content);const template$3=html`<iron-iconset-svg name="image" size="24">
<svg><defs>
...
</iron-iconset-svg>`;document.head.appendChild(template$4.content);const template$5=html`<iron-iconset-svg name="maps" size="24">
<svg><defs>
...
</dom-module>`;document.head.appendChild($_documentContainer.content);const _DBW=new dataBaseworker,__DEV=!0,_STYLES=_DBW.getElementAssets("cms-confirm",__DEV);class cmsConfirm extends PolymerElement{static get template(){return html$1`

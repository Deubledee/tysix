...
export {localVideo, localAudio, remoteVideo, remoteAudio, stream, videoRecorder, audioRecorder}
...
export function createPeerConnection(user) {
    conUser.user = user
...
export function onRemoteOffer(user, message) {
